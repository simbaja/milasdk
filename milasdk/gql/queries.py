...
def appliance_fields_fragment(ds: DSLSchema):
    return (
        ...
        #     ds.Modes.quiet.select(ds.QuietMode.isEnabled),
        #     ds.Modes.housekeeper.select(ds.HousekeeperMode.isEnabled),
        #     ds.Modes.quarantine.select(ds.QuarantineMode.isEnabled),
        #     ds.Modes.sleep.select(ds.SleepMode.isEnabled),
        #     ds.Modes.turndown.select(ds.TurndownMode.isEnabled),
        #     ds.Modes.whitenoise.select(ds.WhitenoiseMode.isEnabled),
        #     ds.Modes.powerSaver.select(ds.PowerSaverMode.isEnabled),
        #     ds.Modes.childLock.select(ds.ChildLockMode.isEnabled)
        # ),
